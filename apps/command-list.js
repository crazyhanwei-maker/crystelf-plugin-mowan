...
function getCommandCategories() {
  return [
    ...
    {
      title: '调试维护',
      subtitle: '控制台、体检、备份、日志与更新',
      tone: 'amber',
      commands: [
        { cmd: '#灵晶状态', desc: '查看插件运行状态图片' },
        { cmd: '#灵晶命令列表', desc: '查看本命令列表图片' },
        { cmd: '#灵晶帮助', desc: '查看帮助导航（可带分类）' },
        { cmd: '#灵晶排查日志', desc: 'AI 排查近期日志' },
        { cmd: '#灵晶健康报告', desc: '生成体检报告文本（仅主人）' },
        { cmd: '#灵晶备份列表', desc: '查看配置备份（仅主人）' },
        { cmd: '#灵晶立即备份', desc: '立即备份一次配置（仅主人）' },
        { cmd: '#群风控日报', desc: '近 7 天风控统计（管理员）' },
        { cmd: '#AI周报', desc: '近 7 天 AI 用量统计' },
        { cmd: '#灵晶任务', desc: '查看定时任务状态（仅主人）' },
        { cmd: '#灵晶水位', desc: '查看磁盘/内存/Redis 水位（仅主人）' },
        { cmd: '#灵晶水位阈值 磁盘 85', desc: '调整水位告警阈值（仅主人）' },
        { cmd: '#查看进程', desc: '查看系统进程（仅主人）' },
        { cmd: '#杀死PID 数字', desc: '结束指定进程（仅主人）' },
        { cmd: '#灵晶重启', desc: '重启 Bot（仅主人，需确认）' },

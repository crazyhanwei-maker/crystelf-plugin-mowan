...
export async function renderDailyGroupSummaryImage(data = {}) {
  ...
  try {
    ...
    await page.setContent(buildDailyGroupSummaryImageHtml(data), { waitUntil: 'domcontentloaded', timeout: 10000 });
    ...
    await page.setViewport({ width: 900, height: Math.min(Math.max(height, 1180), 5200), deviceScaleFactor: 2 });

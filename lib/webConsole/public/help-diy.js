...
function buildHelpHtmlDocument({ badge, title, subtitle, intro, sections, notes, chips, footerUrl }) {
...
function getHelpHtmlTemplate(slot = 'home') {
  ...
  if (!data) return '';
  return buildHelpHtmlDocument({ ...data, chips: HELP_HTML_HEADER_CHIPS[slot] || [], footerUrl: url });
}

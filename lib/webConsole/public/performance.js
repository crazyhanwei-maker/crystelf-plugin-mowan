...
function setLoading() {
  ...
  ['performance-runtime-grid', 'performance-ai-trend', 'performance-image-trend', 'performance-model-table', 'performance-scene-table', 'performance-failure-table', 'performance-slow-list'].forEach(id => {
    const target = document.getElementById(id);

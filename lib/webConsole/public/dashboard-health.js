...
function renderConsoleHealthOverview(overview = {}, health = {}, version = null, audit = {}) {
  const target = document.getElementById('console-health-overview');
  if (!target) return;
  lastConsoleHealthOverviewPayload = { overview, health, version, audit };
  const cards = [

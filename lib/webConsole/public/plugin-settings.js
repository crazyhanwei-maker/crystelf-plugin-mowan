...
async function validateSkillsEditorConfig() {
  ...
  const result = await postJson('/api/plugin-settings/skills-config/validate', { config });
...
async function saveSkillsEditorConfig() {
  ...
  renderSkillsSection();
  const result = await postJson('/api/plugin-settings/skills-config/save', { config });

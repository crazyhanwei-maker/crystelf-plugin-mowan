(() => {
  ...
  const navigation = [
    ...
    { group: '调试', href: '/qq-simulator.html', label: 'QQ 模拟器', icon: '◌' },
    { group: '调试', href: '/sandbox-chat.html', label: '调试对话', icon: '✦' },
    { group: '调试', href: '/file-browser.html', label: '文件编辑', icon: '⌘' },
    { group: '调试', href: '/dependency-check.html', label: '依赖检查', icon: '✓' },

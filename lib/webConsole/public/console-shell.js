(() => {
  ...
  const navigation = [
    ...
    { group: '工具', href: '/qq-simulator.html', label: '模拟调试', icon: '◌' },
    { group: '工具', href: '/sandbox-chat.html', label: '对话测试', icon: '✦' },
    { group: '工具', href: '/command-center.html', label: '命令中心', icon: '⌁' },
    { group: '工具', href: '/file-browser.html', label: '文件编辑', icon: '⌘' },
    { group: '工具', href: '/dependency-check.html', label: '依赖检查', icon: '✓' },
    { group: '工具', href: '/config-diagnostics.html', label: '配置诊断', icon: '◇' },
    { group: '工具', href: '/frontend-diagnostics.html', label: '前端诊断', icon: '!' },

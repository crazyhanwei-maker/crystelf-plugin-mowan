function renderRuleDebuggerPanel(group = {}, disabled = false) {
  ...
  return `
    <div class="group-management-nested-block group-management-rule-debug-block">
      ...
      <div class="group-management-rule-debug-form gm-rd-cols-4">
      ...
      <div class="group-management-rule-debug-section-box" data-rd-section="message">
        <h5>群消息风控</h5>
        <div class="group-management-rule-debug-form gm-rd-full">
        ...
        <div class="group-management-rule-debug-form gm-rd-cols-3">
          <label class="setting-item">
        ...
        <div class="group-management-rule-debug-observe">
          <label class="group-management-switch group-management-rule-debug-switch">
            ...
            <span><strong>模拟新人观察期</strong><small>勾选后按旁边的入群分钟数判断。</small></span>
          </label>
          <label class="setting-item">
      ...
      <div class="group-management-rule-debug-section-box" data-rd-section="join">
        <h5>加群申请</h5>
        <div class="group-management-rule-debug-form gm-rd-full">
          <label class="setting-item group-management-textarea-item">
      ...
      <div class="group-management-rule-debug-section-box" data-rd-section="title">
        <h5>头衔申请</h5>
        <div class="group-management-rule-debug-form gm-rd-full">
          <label class="setting-item">

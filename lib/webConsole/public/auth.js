(function () {
  ...
  const LOCAL_CACHE_EXACT_ITEMS = [
    ...
    { key: 'crystelf.qqSimulator.scenarios.v1', label: 'QQ 模拟器本机场景' },
    { key: 'crystelf.qqSimulator.serverSeen.v1', label: 'QQ 模拟器同步状态' },
  ...
  const LOCAL_CACHE_PREFIX_ITEMS = [
    ...
    { prefix: 'crystelf.qqSimulator.', label: 'QQ 模拟器本机状态' },

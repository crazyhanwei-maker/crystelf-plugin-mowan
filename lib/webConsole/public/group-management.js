        ...
        <div class="group-management-nested-grid">
          ...
          <div class="group-management-nested-block group-management-content-block">
            ...
            ${(() => {
              ...
              return `
                ${renderFeatureSwitch('gm-default-content-url-safety-enabled', '默认启用 URL 智能安检', urlSafety.enabled === true, '对群员发送的网页链接执行 URL 转 Markdown，并用 AI 判断钓鱼、诈骗、恶意下载、灰产引流等风险。默认关闭。', disabled)}
                <div class="settings-grid group-management-small-grid">
                  <label class="setting-item">
                  ...
                  <label class="setting-item">
                    <span class="kv-label">默认 Markdown 最大字符</span>
                  ...
                  <label class="setting-item">
                    <span class="kv-label">默认检查超时毫秒</span>
                ...
                <label class="setting-item group-management-textarea-item">
                  <span class="kv-label">默认 URL 安检白名单</span>
                  ...
                  <div class="setting-help">命中白名单的 URL 不检查；其他 URL 第一次检查后会写入本地缓存，后续直接复用结果。</div>
                </label>
              `;
            })()}
            ...
            <div class="settings-grid group-management-small-grid">
              <label class="setting-item">
                ...
                <div class="setting-help">超过该条数才触发，例如 8 表示第 9 条触发。</div>
              </label>
              <label class="setting-item">
        ...
        <div class="group-management-nested-grid">
          ...
          <div class="group-management-nested-block group-management-content-block">
            ...
            ${(() => {
              ...
              return `
                ${renderFeatureSwitch('gm-content-url-safety-enabled', '启用 URL 智能安检', urlSafety.enabled === true, '对群员发送的网页链接执行 URL 转 Markdown，并用 AI 判断钓鱼、诈骗、恶意下载、灰产引流等风险。默认关闭。', disabled)}
                <div class="settings-grid group-management-small-grid">
                  <label class="setting-item">
                  ...
                  <label class="setting-item">
                    <span class="kv-label">Markdown 最大字符</span>
                  ...
                  <label class="setting-item">
                    <span class="kv-label">检查超时毫秒</span>
                ...
                <label class="setting-item group-management-textarea-item">
                  <span class="kv-label">URL 安检白名单</span>
...
function buildGroupSaveDiffLines(group = {}, payload = {}) {
  ...
  addGroupSaveDiffLine(diffs, 'URL 智能安检', content.urlSafety?.enabled === true, nextContent.urlSafety?.enabled === true);
  ...
  addGroupSaveDiffLine(diffs, 'URL Markdown 最大字符', Number(content.urlSafety?.markdownMaxLength || 6000), Number(nextContent.urlSafety?.markdownMaxLength || 6000));

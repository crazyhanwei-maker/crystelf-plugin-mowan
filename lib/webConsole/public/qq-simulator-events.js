(function () {
  ...
  function getCurrentMessageEventType() {
    return $('qq-simulator-event-type')?.value === 'private_message' ? 'private_message' : 'message';
  }
  ...
  function bindEvents() {
    ...
    $('qq-simulator-chat-input').addEventListener('keydown', event => {
      if (event.key === 'Enter' && !event.shiftKey) {
        ...
        sendEvent(getCurrentMessageEventType());
      }
    });
    ...
    $('qq-simulator-send-message-btn').addEventListener('click', () => sendEvent(getCurrentMessageEventType()));
    $('qq-simulator-chat-send-btn').addEventListener('click', () => sendEvent(getCurrentMessageEventType()));

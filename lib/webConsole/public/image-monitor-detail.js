...
function renderMissingParams(message) {
  ...
  document.getElementById('detail-image-preview').innerHTML = `
    <div class="detail-placeholder">
      ${escapeHtml(message)}
      <div class="actions">
        <a class="link-btn" href="/image-monitor-center.html">\u8fd4\u56de\u56fe\u7247\u76d1\u63a7\u4e2d\u5fc3</a>
      </div>
    </div>
  `;
}
...
async function init() {
  ...
  if (!id) {
    renderMissingParams('\u8bf7\u5148\u4ece\u56fe\u7247\u76d1\u63a7\u4e2d\u5fc3\u6253\u5f00\u67d0\u6761\u8bb0\u5f55\u7684\u8be6\u60c5\u9875\u3002');
    bindCommonActions();
    return;
  }
  ...
  renderKeyValues([
    ...
    { label: '\u672c\u5730\u9884\u89c8\u6587\u4ef6', value: data.localImagePath || data.reviewRelativePath || data.relativeDir || '\u65e0' },
    { label: '\u539f\u59cb\u56fe\u7247\u5730\u5740', value: data.originalImageUrl || data.imageUrl || data.sourceUrl || '\u65e0' },
  ]);

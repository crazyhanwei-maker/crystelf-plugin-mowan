function renderFeatureSection() {
  ...
  const descriptions = {
    ai: '群聊 AI 主功能',
    privateAi: '私聊 AI 对话能力',
    privateAiImage: '私聊生图与改图能力',
    privateAiVoice: '私聊语音合成与语音模型切换',
    privateAiMeme: '私聊表情包发送能力',
    privateAiSkills: '私聊联网搜索与 Skills 工具',
    privateAiSafety: '私聊内容安全拦截与黑名单',
    music: '点歌与音乐能力',
    rss: 'RSS 推送能力',
    auth: '入群验证能力',
    welcome: '入群欢迎能力',

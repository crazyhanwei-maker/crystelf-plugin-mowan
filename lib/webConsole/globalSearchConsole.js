const PAGE_ENTRIES = [
  ...
  { id: 'page:command-center', type: 'page', typeLabel: '页面', title: '命令中心', description: '扫描插件命令、优先级、权限、宽泛监听和重复命令风险。', href: '/command-center.html', badge: '诊断与调试', keywords: ['指令', '优先级', '被抢', '规则', '命令列表'] },

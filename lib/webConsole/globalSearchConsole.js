const PAGE_ENTRIES = [
  ...
  { id: 'page:agent-workbench', type: 'page', typeLabel: '页面', title: 'Agent 工作台', description: '运行 OpenCode 或 MiMo Code 的只读代码分析任务。', href: '/agent-workbench.html', badge: 'AI 能力', keywords: ['Agent', 'OpenCode', 'MiMo Code', '代码分析', '补丁建议'] },

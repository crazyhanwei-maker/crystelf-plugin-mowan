const PAGE_ENTRIES = [
  { id: 'page:index', type: 'page', typeLabel: '页面', title: '总览', description: '运行状态、健康巡检、任务中心、日志排查和快捷入口。', href: '/index.html', badge: '核心', keywords: ['首页', '控制台', '健康', '日志', '任务', '状态'] },
  { id: 'page:plugin-settings', type: 'page', typeLabel: '页面', title: '插件设置', description: '管理插件开关、私聊 AI、安全策略、技能配置和锅巴配置项。', href: '/plugin-settings.html', badge: '设置', keywords: ['配置', '锅巴', '开关', '私聊', '安全', '技能'] },
  { id: 'page:api-settings', type: 'page', typeLabel: '页面', title: 'API 接口', description: '配置 AI、生图、图片监控、搜索、表情包与备用 API。', href: '/api-settings.html', badge: '接口', keywords: ['模型', '备用', 'LLM', '生图', '搜索', '表情包', 'UA'] },
  { id: 'page:bot-plugins', type: 'page', typeLabel: '页面', title: '插件管理', description: '查看已安装插件、插件目录、安装任务、删除和依赖状态。', href: '/bot-plugins.html', badge: '插件', keywords: ['插件目录', '安装插件', '依赖', '删除插件', 'gitee'] },
  { id: 'page:group-management', type: 'page', typeLabel: '页面', title: '群管理', description: '群管理开关、入群欢迎、自动审核、风控、刷屏检测和头衔申请。', href: '/group-management.html', badge: '群聊', keywords: ['欢迎', '加群申请', '群头衔', '刷屏', 'URL 安全', '总结'] },
  { id: 'page:qq-simulator', type: 'page', typeLabel: '页面', title: '模拟调试', description: '模拟 QQ 群聊、私聊、戳一戳、入群申请、图片和语音消息。', href: '/qq-simulator.html', badge: '调试', keywords: ['QQ模拟', '私聊', '消息段', 'CQ码', 'meme', '截图'] },
  { id: 'page:sandbox-chat', type: 'page', typeLabel: '页面', title: '对话测试', description: '在网页里测试 AI 对话、提示词、知识库和工具调用。', href: '/sandbox-chat.html', badge: '调试', keywords: ['沙箱', 'AI测试', '提示词', '工具调用'] },
  { id: 'page:command-center', type: 'page', typeLabel: '页面', title: '命令中心', description: '扫描插件命令、优先级、权限、宽泛监听和重复命令风险。', href: '/command-center.html', badge: '命令', keywords: ['指令', '优先级', '被抢', '规则', '命令列表'] },
  { id: 'page:file-browser', type: 'page', typeLabel: '页面', title: '文件编辑', description: '浏览、打开、复制、编辑和备份插件文件。', href: '/file-browser.html', badge: '文件', keywords: ['文件管理器', '编辑器', '复制', '备份', '打开文件'] },
  { id: 'page:dependency-check', type: 'page', typeLabel: '页面', title: '依赖检查', description: '检查插件依赖、其他插件依赖、自动修复和任务进度。', href: '/dependency-check.html', badge: '维护', keywords: ['修复依赖', 'pnpm', 'npm', '缺失依赖', '安装失败'] },
  { id: 'page:config-diagnostics', type: 'page', typeLabel: '页面', title: '配置诊断', description: '查看配置来源、覆盖关系、运行时配置和建议。', href: '/config-diagnostics.html', badge: '诊断', keywords: ['配置来源', 'runtime', '默认配置', '覆盖'] },
  { id: 'page:frontend-diagnostics', type: 'page', typeLabel: '页面', title: '前端错误诊断', description: '查看页面脚本异常、接口失败、资源加载失败和慢请求记录。', href: '/frontend-diagnostics.html', badge: '诊断', keywords: ['前端诊断', '页面报错', 'JS错误', '404', '500', '请求失败', '资源加载'] },
  { id: 'page:performance', type: 'page', typeLabel: '页面', title: '性能监测', description: '查看 API 主备质量、耗时、熔断、请求趋势和慢请求。', href: '/performance.html', badge: '数据', keywords: ['耗时', '主备', '质量', '熔断', '慢请求', '统计'] },
  { id: 'page:usage-center', type: 'page', typeLabel: '页面', title: 'AI 用量', description: '查看 AI 使用量、费用、场景统计和趋势。', href: '/usage-center.html', badge: '数据', keywords: ['token', '费用', '用量', '统计', 'AI使用量'] },
  { id: 'page:image-monitor', type: 'page', typeLabel: '页面', title: '图片监控', description: '查看图片审核日志、本地图片、清理任务和命中记录。', href: '/image-monitor-center.html', badge: '图片', keywords: ['审核', '本地图片', '表情包', '清理', '命中'] },
  { id: 'page:help-diy', type: 'page', typeLabel: '页面', title: '帮助 DIY', description: '编辑帮助图片、模板、分类和默认帮助样式。', href: '/help-diy.html', badge: '帮助', keywords: ['帮助图', '帮助系统', '模板', '默认帮助'] },
];

const PAGE_ENTRIES = [
  ...
  { id: 'page:bot-logs', type: 'page', typeLabel: '页面', title: 'Bot 日志', description: '直接查看 bot 运行日志文件，支持刷新、向前翻页、级别筛选与关键字搜索。', href: '/bot-logs.html', badge: '诊断与调试', keywords: ['日志', '运行日志', 'log', 'tail', '报错', '排障'] },

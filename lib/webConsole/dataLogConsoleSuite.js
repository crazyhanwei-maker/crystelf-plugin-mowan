...
import { createBotLogsConsole } from './botLogsConsole.js';
import { createBotPluginConsole } from './botPluginConsole.js';
import { createDependencyConsole } from './dependencyConsole.js';
import { createFreeChatUsageConsole } from './freeChatUsageConsole.js';
...
export function createDataLogConsoleSuite(options = {}) {
  ...
  const freeChatUsageConsole = createFreeChatUsageConsole();
  ...
  const botLogsConsole = createBotLogsConsole({
    fs,
    path,
    logger,
    createHttpError,

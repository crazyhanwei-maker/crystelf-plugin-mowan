...
export function createWebConsoleHandlerContext(options = {}) {
  const {
    ...
    logConsole = {},
    taskCenterConsole = {
      buildTaskCenterPayload: () => ({ success: false, error: '任务中心模块不可用', tasks: [] }),
      runTaskManually: async () => ({ success: false, error: '任务中心模块不可用' }),
    },
    healthReportConsole = {
      buildHealthReportPayload: async () => ({ success: false, error: '体检报告模块不可用' }),
      buildHealthReportTextPayload: async () => ({ success: false, error: '体检报告模块不可用' }),
    },
    groupManagementInsightsConsole = {
      buildGroupManagementInsightsPayload: () => ({ success: false, error: '风控面板模块不可用' }),
    },
    getBotAdapterWatchdogStatus = () => ({ success: false, error: '看门狗模块不可用', enabled: false }),
    scheduledBackupConsole = {
      buildScheduledBackupTaskPayload: () => ({ id: 'scheduled-config-backup', name: '配置定时备份', status: 'disabled', statusLabel: '模块不可用', tasks: [] }),
      runBackup: async () => ({ success: false, error: '定时备份模块不可用' }),
      listBackups: () => [],
    },
    logDiagnosisConsole = {
    ...
    botLogsConsole = {
      buildFileList: () => ({ success: false, error: '日志查看模块不可用' }),
      readLogWindow: () => ({ success: false, error: '日志查看模块不可用' }),
    },
    performanceConsole = {},
    configBackupConsole = {},
  ...
  const context = {
    ...
    buildBotLogFileList: botLogsConsole.buildFileList,
    readBotLogWindow: botLogsConsole.readLogWindow,
    buildBotPluginManagementPayload: botPluginConsole.buildPayload,
    buildCommandCenterPayload: commandCenterConsole.buildPayload,
    buildAgentWorkbenchPayload: agentWorkbenchConsole.buildPayload,
    buildAgentWorkbenchVariantIntelligence: agentWorkbenchConsole.buildAgentVariantIntelligence,
    buildAgentWorkbenchModelBadges: agentWorkbenchConsole.buildAgentModelBadges,
    buildAgentWorkbenchNativePayload: agentWorkbenchConsole.buildNativePayload,
    buildAgentWorkbenchUsageStats: agentWorkbenchConsole.buildUsageStats,
    ...
    buildFreeChatUsagePayload: freeChatUsageConsole.buildPayload,
    ...
    buildUsageTrendByDaysPayload: usageTrendConsole.buildUsageTrendByDaysPayload,
    buildTaskCenterPayload: taskCenterConsole.buildTaskCenterPayload,
    runTaskCenterAction: taskCenterConsole.runTaskManually,
    buildHealthReportPayload: healthReportConsole.buildHealthReportPayload,
    buildHealthReportTextPayload: healthReportConsole.buildHealthReportTextPayload,
    buildBotAdapterWatchdogStatus: getBotAdapterWatchdogStatus,
    buildGroupManagementInsightsPayload: groupManagementInsightsConsole.buildGroupManagementInsightsPayload,
    ...
    listScheduledBackups: scheduledBackupConsole.listBackups,
    ...
    cancelAgentWorkbenchTask: agentWorkbenchConsole.cancelTask,
    batchManageAgentWorkbenchTasks: agentWorkbenchConsole.batchManageTasks,
    readAgentWorkspaceImage: agentWorkbenchConsole.readAgentWorkspaceImage,
    archiveAgentWorkbenchTask: agentWorkbenchConsole.archiveTask,
    closeAgentWorkbenchTerminal: agentWorkbenchConsole.closeTerminal,
    closeAgentWorkbenchOpenCode: agentWorkbenchConsole.closeOpenCodeRuntimes,
    closeAgentWorkbenchOpenCodeRuntime: agentWorkbenchConsole.closeOpenCodeRuntime,
    ...
    createAgentWorkbenchTask: agentWorkbenchConsole.createTask,
    createAgentWorkbenchTerminal: agentWorkbenchConsole.createTerminal,
    ...
    uploadFileBrowserFile: fileBrowserConsole.uploadFile,
    ...
    getAgentWorkbenchTask: agentWorkbenchConsole.getTask,
    exportAgentWorkbenchTask: agentWorkbenchConsole.exportTask,
    importAgentWorkbenchTask: agentWorkbenchConsole.importTask,
    getAgentWorkbenchSessionDiff: agentWorkbenchConsole.getSessionDiff,
    getAgentWorkbenchSessionHistory: agentWorkbenchConsole.getSessionHistory,
    listAgentWorkbenchOpenCodeRuntimes: agentWorkbenchConsole.listOpenCodeRuntimes,
    getAgentWorkbenchTaskGitState: agentWorkbenchConsole.getTaskGitState,
    ...
    generateHelpDiyHtmlImage: options.helpDiyConsole?.generateHtmlImage,
    ...
    listAgentWorkbenchTasks: agentWorkbenchConsole.listTasks,
    listAgentWorkbenchTerminals: agentWorkbenchConsole.listTerminals,
    ...
    listPersonaPresets: options.personaPresetConsole?.listPersonaPresets,
    getPersonaPreset: options.personaPresetConsole?.getPersonaPreset,
    savePersonaPreset: options.personaPresetConsole?.savePersonaPreset,
    deletePersonaPreset: options.personaPresetConsole?.deletePersonaPreset,
    ...
    manageAgentWorkbenchSession: agentWorkbenchConsole.manageSession,
    manageAgentWorkbenchTaskGit: agentWorkbenchConsole.manageTaskGit,
    manageAgentWorkbenchWorktree: agentWorkbenchConsole.manageWorktree,
    executeAgentWorkbenchSessionCommand: agentWorkbenchConsole.executeSessionCommand,
    backgroundAgentWorkbenchSession: agentWorkbenchConsole.backgroundSession,
    ...
    readRawBody: httpUtils.readRawBody,
    ...
    resizeAgentWorkbenchTerminal: agentWorkbenchConsole.resizeTerminal,
    ...
    saveAgentWorkbenchConfig: agentWorkbenchConsole.saveConfig,
    resumeAgentWorkbenchTask: agentWorkbenchConsole.resumeTask,
    retryAgentWorkbenchTask: agentWorkbenchConsole.retryTask,
    replyAgentWorkbenchPermission: agentWorkbenchConsole.replyPermission,
    replyAgentWorkbenchQuestion: agentWorkbenchConsole.replyQuestion,
    rejectAgentWorkbenchQuestion: agentWorkbenchConsole.rejectQuestion,
    subscribeAgentWorkbenchEvents: agentWorkbenchConsole.subscribeEvents,
    saveCommandBridgeConfig: commandCenterConsole.saveBridgeConfig,
    ...
    searchAgentWorkbenchWorkspace: agentWorkbenchConsole.searchWorkspace,
    restoreAgentWorkbenchDiffFile: agentWorkbenchConsole.restoreSessionDiffFile,
    sendAgentWorkbenchTerminalInput: agentWorkbenchConsole.sendTerminalInput,

...
function sendText(res, content, statusCode = 200, contentType = 'text/plain; charset=utf-8') {
  res.writeHead(statusCode, {
...
function buildApiSettingsPayload() {
  ...
  return {
    ...
    imageMonitor: {
      ...
      apiKey: imageMonitorConfig.apiKey || '',
    ...
    coreConfig: {
      tools: {
        search: {
          ...
          apiKey: coreConfig.tools?.search?.apiKey || '',
...
async function saveApiSettings(payload = {}) {
  ...
  if (payload.imageMonitor) {
    ...
    const nextImageMonitor = {
      ...
      apiKey: payload.imageMonitor.apiKey,
    ...
    const nextCore = {
      ...
      tools: {
        ...
        search: {
          ...
          apiKey: payload.coreConfig.tools.search.apiKey,
...
function buildEditableConfigPayload() {
  ...
  return {
    webConsole: {
      ...
      webConsolePort: Number(config.webConsolePort || 27831),

...
const CONFIG_SOURCE_LABELS = {
  ...
  'imageConfig.webSearch': 'Agent Plan 联网搜索',
  ...
  'imageConfig.fallbackApi.webSearch': '备用 Agent Plan 联网搜索',
...
const EFFECTIVE_FIELDS = [
  ...
  { file: 'ai', key: 'imageConfig.webSearch', label: 'Agent Plan 联网搜索' },
  ...
  { file: 'ai', key: 'imageConfig.fallbackApi.webSearch', label: '备用 Agent Plan 联网搜索' },

...
const guobaSchema = [
  ...
  },
  {
    ...
    label: '控制台公网地址',
    component: 'Input',
    bottomHelpMessage: '用于 #灵晶登录 生成一次性登录链接。留空时自动查询公网 IP 服务并回退到网卡地址；使用 CDN、NAT 或反向代理时请填写完整 http/https 地址',
    componentProps: {
  ...
  },
  {
    ...
    component: 'Select',
    bottomHelpMessage:
      'openai使用/v1/images/generations接口，ark-agent-plan使用火山方舟Agent Plan，sd-webui使用AUTOMATIC1111/Forge，chat使用对话式生图模型，jimeng使用旧即梦接口',
    componentProps: {
      options: [
        { label: 'OpenAI接口', value: 'openai' },
        { label: '火山 Agent Plan', value: 'ark-agent-plan' },
        { label: 'SD WebUI', value: 'sd-webui' },
  ...
  },
  {
    ...
    label: 'SD WebUI 地址',
    component: 'Input',
    bottomHelpMessage: 'AUTOMATIC1111 或 Forge 地址，启动时必须启用 --api',
    componentProps: { placeholder: '例如 http://127.0.0.1:7860' },
  },
  {
    field: 'ai.imageConfig.sdWebUi.model',
    label: 'SD WebUI 模型',
    component: 'Input',
    bottomHelpMessage: '模型检查点名称；留空使用 WebUI 当前模型',
  },
  {
    field: 'ai.imageConfig.sdWebUi.username',
    label: 'SD WebUI 认证用户',
    component: 'Input',
    bottomHelpMessage: '未启用 API Basic Auth 时留空',
  },
  {
    field: 'ai.imageConfig.sdWebUi.password',
    label: 'SD WebUI 认证密码',
    component: 'InputPassword',
    bottomHelpMessage: '未启用 API Basic Auth 时留空',
  },
  {
    field: 'ai.imageConfig.sdWebUi.samplerName',
    label: 'SD WebUI 采样器',
    component: 'Input',
    componentProps: { placeholder: 'DPM++ 2M' },
  },
  {
    field: 'ai.imageConfig.sdWebUi.scheduler',
    label: 'SD WebUI 调度器',
    component: 'Input',
    componentProps: { placeholder: 'Karras' },
  },
  {
    field: 'ai.imageConfig.sdWebUi.steps',
    label: 'SD WebUI 采样步数',
    component: 'InputNumber',
    componentProps: { min: 1, max: 150, step: 1 },
  },
  {
    field: 'ai.imageConfig.sdWebUi.cfgScale',
    label: 'SD WebUI CFG',
    component: 'InputNumber',
    componentProps: { min: 1, max: 30, step: 0.5 },
  },
  {
    field: 'ai.imageConfig.sdWebUi.width',
    label: 'SD WebUI 宽度',
    component: 'InputNumber',
    componentProps: { min: 64, max: 4096, step: 8 },
  },
  {
    field: 'ai.imageConfig.sdWebUi.height',
    label: 'SD WebUI 高度',
    component: 'InputNumber',
    componentProps: { min: 64, max: 4096, step: 8 },
  },
  {
    field: 'ai.imageConfig.sdWebUi.negativePrompt',
    label: 'SD WebUI 负面提示词',
    component: 'InputTextArea',
    componentProps: { rows: 3 },
  },
  {
    field: 'ai.imageConfig.sdWebUi.seed',
    label: 'SD WebUI 随机种子',
    component: 'InputNumber',
    bottomHelpMessage: '-1 表示随机',
    componentProps: { min: -1, max: 2147483647, step: 1 },
  },
  {
    field: 'ai.imageConfig.sdWebUi.denoisingStrength',
    label: 'SD WebUI 重绘强度',
    component: 'InputNumber',
    bottomHelpMessage: '仅图生图使用；所有请求固定只生成一张图片',
